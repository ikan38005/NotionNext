...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hai, Saya seorang programmer, Hai, Saya seorang pelajar, Hai, Saya seorang penulis, Selamat datang di blog saya 🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Pelajar di Ashimah', // Biografi penulis
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://youtube.com/', // Halaman YouTube Anda
